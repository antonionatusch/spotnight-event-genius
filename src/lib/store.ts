...
const events: EventItem[] = [
  ...
  },
  {
    ...
    status: 'active',
    ticketTypes: [{ id: 't1', name: 'General', price: 60, capacity: 400, available: 220 }],
  },
];
...
const seedReservations: Reservation[] = [
  {
    ...
    code: 'SN-001',
    eventId: 'e1',
    eventName: 'La Tuti Viruli',
    venueName: 'SpotNight Club',
    userName: 'Ana López',
    ticketType: 'Mesa',
    peopleCount: 4,
    totalAmount: 250,
    spotNightCommission: 25,
    status: 'Confirmada',
    venueMapItemId: 'PB-M02',
    venueMapItemLabel: 'M02',
    zone: 'General',
    floor: 'planta_baja',
  ...
  },
  {
    ...
    eventName: 'La Tuti Viruli',
    venueName: 'SpotNight Club',
    userName: 'Bruno Pérez',
    ticketType: 'General',
    peopleCount: 2,
    totalAmount: 300,
    spotNightCommission: 30,
    status: 'Ingresó',
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    peopleCount: 6,
    totalAmount: 700,
    spotNightCommission: 70,
    status: 'Confirmada',
    venueMapItemId: 'PA-V01',
    venueMapItemLabel: 'V01',
    zone: 'VIP',
    floor: 'planta_alta',
    createdAt: new Date().toISOString(),
  },
  {
    ...
    spotNightCommission: 25,
    status: 'Confirmada',
    venueMapItemId: 'PB-M06',
    venueMapItemLabel: 'M06',
    zone: 'General',
    floor: 'planta_baja',
    createdAt: new Date().toISOString(),
  },
